...
public class Analizador {
    ...
    String keyWord = "(if|else|for|while|as|assert|break|class|continue|def|del|elif|except|finally|from|global|import|in|is|lambda|None|nonlocal|pass|raise|return|try|with|yield|print)";
